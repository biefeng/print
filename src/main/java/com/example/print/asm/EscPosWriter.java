...
public class EscPosWriter {
     ...
     */
    public EscPosWriter text(String text) throws UnsupportedEncodingException {
        return bytes(text.getBytes("gbk"));
    }
